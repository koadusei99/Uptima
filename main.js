...
toggle.addEventListener("click", () => {
  ...
  if (disp === "none") {
    ...
    navbar.style.backgroundColor = "var(--prim)";
    links.forEach((l) => {
      l.style.color = "#fff";
    });
